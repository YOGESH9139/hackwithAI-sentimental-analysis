...
const agents = [
  ...
  },
  {
    ...
    bgGlow: 'group-hover:shadow-[0_0_30px_rgba(249,115,22,0.2)]',
    description: 'Seeks high-growth opportunities. Analyzes momentum, market trends, and emerging sector leaders.',
    traits: ['Momentum', 'Tech Focus', 'Trending']
  },
  {
    name: 'Aggressive',
    initial: 'A',
  ...
  },
  {
    ...
    initial: 'AE',
    risk: 'Adaptive',
    riskColor: 'bg-primary/20 text-primary border-primary/30',
    bgGlow: 'group-hover:shadow-[0_0_40px_rgba(0,208,148,0.3)]',
    description: 'The master orchestrator. Weighs all agent opinions, manages debates, and synthesizes the final consensus.',
    traits: ['Consensus Building', 'Final Decision', 'Orchestration']
  }
]
